...
class PathFollower:
    ...
    def follow(self, current_pos, path, action_size):
        """
        ...
        action = self._compute_action_to_waypoint(current_pos, target_waypoint, action_size)
    ...
    def _compute_action_to_waypoint(self, current_pos, target_waypoint, action_size):
        """
